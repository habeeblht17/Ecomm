<x-guest-layout>
    ...
    <section class="container flex-grow mx-auto max-w-[1200px] border-b py-5 lg:grid lg:grid-cols-2 lg:py-10">
        ...
        <div class="px-5 mx-auto lg:px-5">
          ...
          <p class="font-bold">Brand: <span class="font-normal">{{ $product->brand->name }}</span></p>
          <p class="font-bold">
            Cathegory: <span class="font-normal">shop</span>
          </p>
          <p class="font-bold">
          ...
          <div class="flex flex-row items-center gap-6 mt-7">
            ...
            <button
              class="flex items-center justify-center w-1/3 h-12 duration-100 bg-amber-400 hover:bg-yellow-300"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
    ...
    <section class="container mx-auto grid max-w-[1200px] grid-cols-2 gap-3 px-5 pb-10 lg:grid-cols-4" >
        ...
        <div class="relative flex flex-col">
          <div  class="absolute flex justify-center w-full gap-3 pt-16 duration-150 opacity-0 h-1/2 hover:opacity-100">
            <span
