<x-guest-layout>
    <!-- Hero image  -->
    <div class="relative ">
        <x-sliders.slider :sliders="$sliders"/>
    </div>
    <!-- /Hero image  -->
    ...
    <section class="container flex flex-col justify-center gap-3 mx-auto my-8 lg:flex-row">
        ...
        <div
        class="flex flex-row items-center justify-center px-5 py-4 mx-5 border-2 border-yellow-400"
        >
        <div class="">
            <svg
            ...
            stroke-width="1.5"
            stroke="currentColor"
            class="w-6 h-6 text-violet-900 lg:mr-2"
            >
            <path
            ...
            <ul class="splide__list mx-auto max-w-[1200px]">
                ...
                <li class="splide__slide">
                    <div class="flex flex-col">
                        <img
                        class=""
                        src="{{ asset('assets/images/product-bigsofa.png') }}"
                        alt="sofa image"
                        />
                ...
                <li class="splide__slide">
                    <div class="flex flex-col">
                        <img
                        class=""
                        src="{{ asset('assets/images/product-sofa.png') }}"
                        alt="Sofa image"
                        />
    ...
    <div class="mx-auto max-w-[1200px] px-5">
        ...
        <div class="px-3 py-8 lg:px-16">
            ...
            <button
            href="#"
            class="px-4 py-2 mt-6 duration-100 bg-amber-400 hover:bg-yellow-300"
            >
            Shop now
            </button>
        </div>
